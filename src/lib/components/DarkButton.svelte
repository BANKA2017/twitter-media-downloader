...
<div
    class="aspect-square rounded-xl text-3xl hover:bg-sky-100 bg-gray-100 dark:bg-gray-800 dark:hover:bg-sky-900 dark:text-white cursor-pointer"
    on:click={switchDarkModeProxy}
>
    {#if darkMode === '0'}
        <!--auto-->
        <svg
